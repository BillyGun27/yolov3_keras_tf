...
from utils.core import yolo_eval
from utils.utils import letterbox_image,letterbox_image_cv
import os
...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        if self.model_image_size != (None, None):
            ...
            boxed_image = letterbox_image_cv(image, tuple(self.model_image_size))
        ...
        boxed_image_ = cv2.cvtColor(boxed_image, cv2.COLOR_BGR2RGB)
       ...
       # thickness = (image.size[0] + image.size[1]) // 300
        ...
        #    label_size = draw.textsize(label, font)
            ...
            print(label, box , (left, top), (right, bottom), ( (right-left) ,(bottom-top) ) )
...
def detect_video(yolo, video_path, output_path=""):
    ...
    while True:
        ...
        image = frame #Image.fromarray(frame)
