...
from utils.distillation import apprentice_distill_loss, distill_data_generator_wrapper
...
def _main():
   ...
   # test_path = '2007_test.txt'
    ...
    #custom_loss = apprentice_distill_loss
    #custom_loss_name = 'apprentice_distill_loss'
    is_tiny_version = len(anchors)==6 # default setting
    if is_tiny_version:
   ...
   #     test_lines = f.readlines()
    ...
    if True:
        ...
        model.compile(optimizer=Adam(lr=1e-4), loss={ 
            'apprentice_distill_loss' : lambda y_true, y_pred: y_pred}) # recompile to apply the change
