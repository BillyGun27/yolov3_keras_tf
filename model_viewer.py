...
#from model.squeezenet import squeezenet_body,yolo_body
...
#plot(darknet , to_file='{}.png'.format("darknet_ref_yolo"), show_shapes=True)
#darknet.summary()
#darknet.save_weights('empty_medium_yolo.h5')
