...
def _main():
   ...
   #     test_lines = f.readlines()
    ...
    if True:
        ...
        history = model.fit_generator(distill_data_generator_wrapper_tf(train_lines, batch_size, input_shape, anchors, num_classes,detection_graph,graph_names),
                steps_per_epoch=max(1, num_train//batch_size),
                validation_data=distill_data_generator_wrapper_tf(train_lines, batch_size, input_shape, anchors, num_classes,detection_graph,graph_names),
