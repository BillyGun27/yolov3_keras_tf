...
def distill_create_model(main_body, custom_loss ,custom_loss_name ,input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
...
def distill_create_tiny_model(main_body, custom_loss ,custom_loss_name ,input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
